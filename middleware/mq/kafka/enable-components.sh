...
do_start()
{
    ...
    echo -e "\nkafka-eagle\n"
    kafka-eagle/start-service.sh $scale
...
do_stop()
{
    ...
    echo -e "\nkafka-eagle\n"
    kafka-eagle/stop-service.sh $scale
...
do_deploy()
{
    ...
    echo -e "\nkafka-eagle\n"
    kafka-eagle/deploy-service.sh $scale
...
do_clean()
{
    ...
    echo -e "\nkafka-eagle\n"
    kafka-eagle/clean-service.sh $scale
...
do_status()
{
    ...
    echo -e "\nkafka-eagle\n"
    kafka-eagle/status-service.sh $scale
